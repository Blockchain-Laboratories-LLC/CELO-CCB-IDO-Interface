    ...
    <InputPanel id={id}>
      <Container hideInput={hideInput}>
        ...
        <InputRow style={hideInput ? { padding: '0', borderRadius: '8px' } : {}} selected={disableTokenSelect}>
          ...
          >
            <Aligner>
              <TokenLogo type={field} address={token?.address} size={'24px'} />
              {field == "INPUT" ? <StyledTokenName className="pair-name-container">
                CELO
              </StyledTokenName> : <StyledTokenName className="pair-name-container">
                CCB
              </StyledTokenName>}
            </Aligner>
          </CurrencySelect>
