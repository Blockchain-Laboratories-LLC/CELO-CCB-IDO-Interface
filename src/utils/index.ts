...
import ccbIDOABI from "../constants/abis/ccbIDO.json";
import { ROUTER_ADDRESS, IDO_ADDRESS } from '../constants'
...
export function getIDOContract(_: number, library: Web3Provider, account?: string) {
  return getContract(IDO_ADDRESS, ccbIDOABI, library, account)
}
